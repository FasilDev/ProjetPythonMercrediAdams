...
def afficher_boutique(ecran):
    ...
    # Definition des objets avec leurs images
    ...
    while True:
        ...
        # Taille des objets proportionnelle
        taille_objet = int(hauteur * 0.1)

        # Position du rectangle violet dans l'image
        ...
        # Afficher le nombre de pieces du joueur (en haut)
        ...
        for i, (bouton, objet) in enumerate(zip(boutons_objets, objets)):
            ...
            # Nombre possede (en haut a droite de l'objet)
